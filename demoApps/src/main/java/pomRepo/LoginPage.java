...
public class LoginPage {
	...
	@FindBy(xpath = "//div[text()='Registered successfully']") private WebElement registerSuccessfulMsg;

	@FindBy(xpath = "//div[text()='Signin successful']") private WebElement signinSuccessfulMsg;
